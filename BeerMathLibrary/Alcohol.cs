...
namespace BeerMath
{
	...
	public class Alcohol
	{
		...
		public static decimal CalculateAbv (decimal OriginalGravity, decimal FinalGravity)
		{
			return (OriginalGravity - FinalGravity) * _AbvFactor(OriginalGravity - FinalGravity);
		}
		
		public static decimal CalculateAbw (decimal OriginalGravity, decimal FinalGravity)
		{
			return (AbwMagicNumber * CalculateAbv(OriginalGravity, FinalGravity)) / FinalGravity;
		}
